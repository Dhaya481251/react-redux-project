        ...
        <ul>
            ...
            <div className='lists'>
                <li onMouseEnter={handleHover}>
                    ...
                    {(currentUser && role==='user' && hover) && (
                        <div className="user-list" onMouseLeave={removeHover}>
                            <ul>
                                <li ><NavLink to='/profile' style={{color:'white',textDecoration:'none'}}>My Profile</NavLink><span><img className="arrow" src={rightArrow} alt="" /></span></li>
                            </ul>
                        </div>
                    )}
                </li>
